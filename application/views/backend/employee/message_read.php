    ...
    <div class="mail-info">
        ...
        <div class="mail-sender " style="padding:7px;">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span><?php echo $this->db->get_where('user', array('user_id' => $sender_id))->row()->name; ?></span>
            </a>
        </div>
...
<?php echo form_open(site_url('employee/message/send_reply/'). $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
