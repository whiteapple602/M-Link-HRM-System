<a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('modal/popup/leave_add'); ?>');" 
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/leave_edit/'.$row['leave_id']); ?>');">
                            ...
                            <li>
                                <a href="#" onclick="confirm_modal_hard_reload('<?php echo site_url('employee/leave/delete/'.$row['leave_id']); ?>');">
