...
<head>
	...
	?>
	<title><?php echo get_phrase('login');?> | <?php echo $system_name;?></title>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<!--<div class="login-bottom-links">
				...
				<a href="<?php echo base_url();?>index.php?login/forgot_password" class="link"><?php echo get_phrase('forgot_password');?> ?</a>
